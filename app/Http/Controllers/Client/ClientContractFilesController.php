...
class ClientContractFilesController extends ClientBaseController
{
...
//            $this->logProjectActivity($request->contract_id, __('messages.newFileUploadedToTheProject'));
        ...
        if ($request->view == 'list') {
            $view = view('client.contracts.contract-files.ajax-list', $this->data)->render();
        } else {
            $view = view('client.contracts.contract-files.thumbnail-list', $this->data)->render();
        }
...
//                $this->logProjectActivity($request->contract_id, __('messages.newFileUploadedToTheProject'));
        ...
        return Reply::redirect(route('client.contracts.index'), __('modules.contracts.projectUpdated'));
    }
    ...
    public function show($id)
    {
        ...
        return view('client.contracts.contract-files.show', $this->data);
    }
