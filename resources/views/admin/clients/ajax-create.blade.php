...
<div class="modal-body">
    <div class="portlet-body">
        {!! Form::open(['id'=>'ajxCreateClient','class'=>'ajax-form','method'=>'POST']) !!}
        ...
        <div class="form-actions">
            <button type="button" id="ajax-save-client" class="btn btn-success"> <i class="fa fa-check"></i> @lang('app.save')</button>
        </div>
        {!! Form::close() !!}
    </div>
</div>
...
<script>
    ...
    $('#ajax-save-client').click(function () {
        $.easyAjax({
            url: '{{route('admin.clients.store')}}',
            container: '#ajxCreateClient',
            type: "POST",
            data: $('#ajxCreateClient').serialize(),
