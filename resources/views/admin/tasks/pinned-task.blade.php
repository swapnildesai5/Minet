            ...
            <table class="table" id="pinnedTaskTable">
                ...
                @forelse($pinnedItems as $key=>$pinnedItem)
                    <tr id="project-{{ $pinnedItem->id }}">
                        ...
                        <td><a href="javascript:;" class="show-task-detail btn btn-info btn-circle" data-toggle="tooltip" data-original-title="@lang('app.view')"><i class="fa fa-search" aria-hidden="true"></i> </a></td>
                    </tr>
                @empty
                    <tr>
