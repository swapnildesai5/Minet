    ...
    $(function() {
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                text: "@lang('messages.deleteCreditNotes')",
                type: "warning",
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#credit-notes-table').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('member.all-credit-notes.data') !!}?startDate=' + encodeURIComponent(startDate) + '&endDate=' + encodeURIComponent(endDate) + '&projectID=' + projectID+ '&clientID=' + clientID,
            "order": [[ 0, "desc" ]],
            language: {
